...
namespace P42.SandboxedStorage.Native
{
    class StorageFolder : StorageItem, IStorageFolder
    {
        ...
        public async Task<IStorageFile> CreateFileAsync(string desiredName)
        {
            ...
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.CreateFileAsync(desiredName));
        ...
        public async Task<IStorageFile> CreateFileAsync(string desiredName, CreationCollisionOption options)
        {
            ...
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.CreateFileAsync(desiredName, (Windows.Storage.CreationCollisionOption)options));
                if (result is Windows.Storage.StorageFile file)
                    return new StorageFile(file);
            }
            return null;
        ...
        public async Task<IStorageFolder> CreateFolderAsync(string desiredName)
        {
            ...
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.CreateFolderAsync(desiredName));
        ...
        public async Task<IStorageFolder> CreateFolderAsync(string desiredName, CreationCollisionOption options)
        {
            ...
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.CreateFolderAsync(desiredName, (Windows.Storage.CreationCollisionOption)options));
                if (result is Windows.Storage.StorageFolder folder)
                    return new StorageFolder(folder);
            }
            return null;
        ...
        public static async Task<IStorageFolder> GetFolderFromPathAsync(string path)
        {
            ...
            {
                if (await RequestAccess<StorageFolder>(path) is StorageFolder storageFolder)
        ...
        public async Task<IReadOnlyList<IStorageFile>> GetFilesAsync(string pattern = null)
        {
            ...
            if (_folder != null)
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.GetFilesAsync());
        ...
        public async Task<IReadOnlyList<IStorageFolder>> GetFoldersAsync(string pattern = null)
        {
            ...
            if (_folder != null)
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.GetFoldersAsync());
        ...
        public async Task<IReadOnlyList<IStorageItem>> GetItemsAsync(string pattern = null)
        {
            ...
            if (_folder != null)
            {
                var result = await TryNativeMethod(this, async (f) => await f._folder.GetItemsAsync());
